...
use Yakimun\JsonSchemaValidator\Vocabulary\CoreVocabulary\VocabularyKeyword;

/**
 * @covers \Yakimun\JsonSchemaValidator\Vocabulary\CoreVocabulary\VocabularyKeyword
...
final class VocabularyKeywordTest extends TestCase
{
    ...
    public function testProcess(array $properties): void
    {
        ...
        $context = new SchemaContext(new SchemaFactory(['$vocabulary' => $this->keyword]), $identifier);
        $expectedContext = new SchemaContext(new SchemaFactory(['$vocabulary' => $this->keyword]), $identifier);
