...
/**
 * @covers \Yakimun\JsonSchemaValidator\Vocabulary\ApplicatorVocabulary\AdditionalPropertiesKeywordHandler
...
final class AdditionalPropertiesKeywordHandlerTest extends TestCase
{
    public function testConstruct(): void
    {
        ...
        $keywordHandler = new AdditionalPropertiesKeywordHandler($schemaValidator);
