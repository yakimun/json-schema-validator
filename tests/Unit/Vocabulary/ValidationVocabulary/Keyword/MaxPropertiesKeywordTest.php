...
final class MaxPropertiesKeywordTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->processor = new SchemaProcessor(['maxProperties' => $this->keyword]);
    }

    public function testProcess(): void
    {
        $maxProperties = 0;
        $value = new JsonInteger($maxProperties);
        ...
        $expected = [new MaxPropertiesKeywordValidator($maxProperties)];
