...
final class MaxItemsKeyword implements Keyword
{
    ...
    {
        $property = $properties['maxItems'];
        $identifier = (string)$context->getIdentifier()->addTokens('maxItems');
        ...
        $context->addKeywordHandler(new MaxItemsKeywordHandler($identifier, $maxItems));
    }
}
